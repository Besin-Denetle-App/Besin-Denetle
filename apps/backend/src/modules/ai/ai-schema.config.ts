  ...
  properties: {
    ...
    nutrition: {
      ...
      properties: {
        ...
        energy: { type: Type.NUMBER, description: 'Enerji (kcal)' },
        fat: { type: Type.NUMBER, description: 'Yağ (g)' },
        saturatedFat: {
          type: Type.NUMBER,
          nullable: true,
          description: 'Doymuş Yağ (g)',
        },
        cholesterol: {
          type: Type.NUMBER,
          nullable: true,
          description: 'Kolesterol (mg) - Nadir',
        },
        carbohydrates: { type: Type.NUMBER, description: 'Karbonhidrat (g)' },
        sugars: {
          type: Type.NUMBER,
          description: 'Şekerler (g)',
        },
        polyols: {
          type: Type.NUMBER,
          nullable: true,
          description: 'Polioller (g)',
        },
        starch: {
          type: Type.NUMBER,
          nullable: true,
          description: 'Nişasta (g)',
        },
        fiber: {
          type: Type.NUMBER,
          nullable: true,
          description: 'Lif/Fiber (g)',
        },
        ...
        vitamins: {
          ...
          nullable: true,
          description:
            'Vitaminler - Sadece belirli oranın üzerindeyse (örn: {"vitamin_c": 10, "vitamin_d": 5})',
        },
        minerals: {
          type: Type.OBJECT,
          nullable: true,
          description:
            'Mineraller - Sadece belirli oranın üzerindeyse (örn: {"calcium": 120, "iron": 2})',
        },
      },
      required: [
        'servingSize',
