...
import { assertHumanFood, isHumanFoodType } from '../../common/utils/food-check.util';
...
export class ProductController {
    ...
    async scan(
        ...
        if (barcodeEntity) {
            ...
            const isHumanFood = isHumanFoodType(barcodeEntity.type);
        ...
        const isHumanFood = isHumanFoodType(aiResult.productType);
    ...
    async flagBarcode(
        ...
        if (isHumanFoodType(barcode.type)) {
